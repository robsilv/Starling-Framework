package
{
	...
	public class GraphicsExample extends Sprite
	{
		...
		private function onAdded ( e:Event ):void
		{
			...
			sprite.graphics.beginBitmapFill(new CheckerBMP(), m);
			...
			sprite.graphics.beginTextureFill(rockTexture, m);
			sprite.graphics.lineTexture(20, grassTexture);
			sprite.graphics.drawRect(top, left, right, bottom);
			sprite.graphics.endFill();
